...
public class RegisteredClient implements Serializable {
    ...
    public Set<String> getPostLogoutRedirectUri() {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.id, that.id) &&
                ...
                Objects.equals(this.postLogoutRedirectUri, that.postLogoutRedirectUri);
    }
    ...
    public int hashCode() {
        return Objects.hash(this.id, this.clientId, this.clientIdIssuedAt, this.clientSecret, this.clientSecretExpiresAt,
                ...
                this.scopes, this.clientSettings, this.tokenSettings, this.postLogoutRedirectUri);
    }
    ...
    public static class Builder implements Serializable {
        ...
        private ClientSettings clientSettings;
        private TokenSettings tokenSettings;
        private Set<String> postLogoutRedirectUri = new HashSet<>();
        ...
        public Builder postLogoutRedirectUri(String postLogoutRedirectUri) {
            this.postLogoutRedirectUri.add(postLogoutRedirectUri);
            return this;
        }
        ...
        private RegisteredClient create() {
            ...
            registeredClient.postLogoutRedirectUri = Collections.unmodifiableSet(this.postLogoutRedirectUri);
        ...
        private void validPostLogoutRedirectUris() {
            if (CollectionUtils.isEmpty(this.postLogoutRedirectUri)) {
                return;
            }
            for (String redirectUri : postLogoutRedirectUri) {
                Assert.isTrue(validateRedirectUri(redirectUri),
                        "post_logout_redirect_uri \"" + redirectUri + "\" is not a valid redirect URI or contains fragment");
            }
        }
